...
with source_data as (
    select distinct
        ...
        cast(selection_score_version as string) as selection_score_version,
        cast(risk_adjusted_score as float64) as risk_adjusted_score,
        cast(return_score as float64) as return_score,
        cast(risk_control_score as float64) as risk_control_score,
        cast(tail_resilience_score as float64) as tail_resilience_score,
        cast(diversification_quality_score as float64) as diversification_quality_score,
        cast(historical_drawdown_abs as float64) as historical_drawdown_abs,
        cast(var_95_pct_of_initial as float64) as var_95_pct_of_initial,
        cast(cvar_95_pct_of_initial as float64) as cvar_95_pct_of_initial,
        cast(simulation_tail_drawdown_abs as float64) as simulation_tail_drawdown_abs,
